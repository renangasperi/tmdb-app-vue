<template>
  <h3 class="text-2xl text-blue-dark mb-3">Filmes Com Melhor Classificação</h3>
...
const { topRatedMovies, getTopRatedMovies, loading } = useMovies();

const loadMoreMovies = () => {
  if (!topRatedMovies.value) return;

  getTopRatedMovies(topRatedMovies.value.page + 1);
};
